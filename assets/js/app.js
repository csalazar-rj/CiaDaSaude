...
const FOOTER = {
  ...
  horario: "Segunda a sexta, 8h as 18h | Sabado, 8h as 13h",
...
function renderFooter() {
  ...
  el.innerHTML = `
    <div class="footer-grid">
      <div>
        <h3>${FOOTER.nome}</h3>
        <p>Farmacia de manipulacao com atendimento humanizado, formulas personalizadas e acompanhamento tecnico.</p>
      </div>
      <div>
        <h3>Atendimento</h3>
        <p>${FOOTER.endereco}</p>
